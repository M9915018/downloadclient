...
public class DownloadMain {
    ...
    public static void main(String[] args) throws Exception {
        //LogUtils.DEBUG = true;
        //args[0] ="http://hkg.download.datapacket.com/100mb.bin";
         // http://localhost:9310/download/file/av_test.mp4
        ...
        LogUtils.info("DOWNLOAD_THREAD_NUM:{}", DOWNLOAD_THREAD_NUM);
    ...
    public void download(String url) throws Exception {
        ...
        // 获取网络文件具体大小
        long httpFileContentLength = HttpUtls.getHttpFileContentLength(url);  // 第一次请求获取文件大小
